...
<div class="site-breadcrumb" style="background: url(assets/img/breadcrumb/01.jpg)">
    <div class="container">
        <h2 class="breadcrumb-title">SAT</h2>
            ...
            <div class="row">
                    ...
                    <div class="department-sidebar">
                        <div class="widget category">
                            ...
                            <div class="category-list">
                                ...
                                <a href="/ss1-foundation"><i class="far fa-long-arrow-right"></i>SS1 Foundation Class</a>
                ...
                <div class="col-xl-8 col-lg-8">
                    <div class="department-details">
                        ...
                        <div class="department-details">
                            <h3 class="mb-20">SAT</h3>
                            <p class="mb-20">
                            The SAT is a standardized college admissions test widely used across the United States. It assesses students’ readiness for college and provides colleges with a common data point to compare applicants. The SAT is an essential stepping stone for students aiming to pursue higher education.
                            </p>
